...
import compactsLight from '../../assets/compacts-light.png';
import compactsDark from '../../assets/compacts-dark.png';
...
<figure style="margin:2rem 0;">
	<picture>
		<source srcset={compactsDark.src} media="(prefers-color-scheme: dark)" />
		<img
			src={compactsLight.src}
			width={compactsLight.width}
			height={compactsLight.height}
			alt="A loop. Kicking off the session leads into build and steer. When the context fills, it compacts by summarizing itself, then resumes and returns to build and steer, twenty-six times. A phone nudges the work from outside working hours."
			style="width:100%;height:auto;border:1px solid rgb(var(--border));border-radius:12px;"
		/>
	</picture>
	<figcaption style="text-align:center;color:rgb(var(--gray));font-size:0.85em;margin-top:0.6rem;">Work until the context fills, compact into a self-summary, resume. Twenty-six times, and the thread never resets.</figcaption>
</figure>
