---
title: 'I check my Claude usage way too much'
...
problem: "Show Claude and Codex rate limits without polling credentials or private APIs."
pubDate: '2026-07-17'
...
<CodeLink href="https://github.com/sifxtreme/agent-usage-bar" label="agent-usage-bar" />
...
<figure style="margin:2rem 0;text-align:center;">
	<img
		src="/agent-usage-bar-menubar.png"
		alt="A macOS menu bar showing two stacked rows: CC 12% 28% for Claude Code, CX 14% for Codex."
		style="width:190px;height:auto;image-rendering:crisp-edges;border:1px solid rgb(var(--border));border-radius:8px;"
	/>
	<figcaption style="color:rgb(var(--gray));font-size:0.85em;margin-top:0.6rem;">Both now. CC is Claude Code, CX is Codex.</figcaption>
</figure>
