...
problem: "Prevent an old Claude binary from deleting sessions after rejecting settings."
pubDate: '2026-07-13'
...
<Figure
	label="Two lanes reading one settings file. My laptop, running a current Claude, understands every key and keeps sessions for 365 days. My agent, running an old Claude, hits a key it has never heard of, throws away the whole file, and falls back to deleting after 30 days."
	caption="Same file. Two readers. Only one of them throws it away."
>
	<svg viewBox="0 0 776 208" xmlns="http://www.w3.org/2000/svg"><defs><marker id="dg-arrow" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="context-stroke"/></marker></defs>
	  <path class="d-edge d-accent" d="M180 90 C230 72 244 62 268 60" marker-end="url(#dg-arrow)"/>
	  <path class="d-edge d-accent" d="M474 58 L512 58" marker-end="url(#dg-arrow)"/>
	  <path class="d-edge d-dash" d="M180 118 C230 136 244 146 268 148" marker-end="url(#dg-arrow)"/>
	  <path class="d-edge d-dash" d="M474 148 L512 148" marker-end="url(#dg-arrow)"/>
	  <rect class="d-card" x="24" y="76" width="156" height="58" rx="11"/>
	  <text class="d-txt" x="102" y="101" text-anchor="middle" font-size="14">settings file</text>
	  <text class="d-txt d-sub" x="102" y="120" text-anchor="middle" font-size="11.5">keep 365 days</text>
	  <rect class="d-card d-accent" x="270" y="30" width="204" height="56" rx="11"/>
	  <text class="d-txt d-accent" x="372" y="54" text-anchor="middle" font-size="14">laptop, current Claude</text>
	  <text class="d-txt d-sub" x="372" y="72" text-anchor="middle" font-size="11.5">understands every key</text>
	  <rect class="d-card d-accent" x="514" y="30" width="176" height="56" rx="11"/>
	  <text class="d-txt d-accent" x="602" y="63" text-anchor="middle" font-size="14">keeps 365 days</text>
	  <rect class="d-card d-dim" x="270" y="120" width="204" height="56" rx="11"/>
	  <text class="d-txt" x="372" y="144" text-anchor="middle" font-size="14">agent, old Claude</text>
	  <text class="d-txt d-sub" x="372" y="162" text-anchor="middle" font-size="11.5">hits a key it never heard of</text>
	  <rect class="d-card d-dim" x="514" y="120" width="176" height="56" rx="11"/>
	  <text class="d-txt" x="602" y="144" text-anchor="middle" font-size="13.5">throws the file away</text>
	  <text class="d-txt d-sub" x="602" y="162" text-anchor="middle" font-size="11.5">deletes after 30 days</text>
	</svg>
</Figure>
